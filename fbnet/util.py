...
def get_train_ds(args, kv=None):
    ...
    train = mx.io.ImageRecordIter(
        ...
        data_shape          =(3, 108, 108),
        batch_size          =args.batch_size,
        resize              =128,
        shuffle             =True,
        prefetch_buffer     =4, ##default
        max_rotato_angle    =90,
        random_resized_crop =True,
        max_random_area     =65536,
        min_random_area     =11664,
...
class CosineDecayScheduler_Grad(LRScheduler):
    ...
    def __call__(self, num_update):
        ...
        if T_cur > self.T_0:
            ...
            self.mini_lr = self.init_lr * self.alpha / self.m_mul
            self.rise_grad = (self.init_lr - self.mini_lr) / self.rise_region
